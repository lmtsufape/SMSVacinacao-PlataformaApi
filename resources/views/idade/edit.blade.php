            ...
            <div class="form-group col-md-12 mb-5">
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" min="1" class="form-control" id="idade_ini" placeholder="Idade início" name="idade_ini" value="{{$obj->idade_ini}}" required autocomplete="idade_ini" autofocus>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="idade_end">Idade Final *</label>
                        <input type="number" min="1" class="form-control" id="idade_end" placeholder="Idade final" name="idade_end" value="{{$obj->idade_end}}" required autocomplete="idade_end" autofocus>
                    </div>
                </div>
                <div class="form-row">
